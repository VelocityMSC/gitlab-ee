...
pkgver=11.10.0
pkgrel=1
pkgdesc="Self-hosted git management"
arch=('x86_64')
...
prepare() {
    # Get first 8 characters from sha1 which has 40 characters in total
    ...
    # Patch config files
    echo "Patching paths and username in gitlab.yml..."
    sed -e "s|/home/git/gitaly/bin|/usr/bin|" \
    ...
    echo "Patching username in database.yml..."
